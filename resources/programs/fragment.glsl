...
vec3 renderAAx4(){  //Render the image 4 by shifting the uv vector and return the arithmetic color average
    vec4 e = vec4(0.125, -0.125, 0.375, -0.375);
    vec3 colAA = render(e.xz) + render(e.yw) + render(e.wx) + render(e.xy);
    return colAA /= 4.0;
